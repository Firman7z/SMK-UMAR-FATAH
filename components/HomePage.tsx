...
const HomePage: React.FC<HomePageProps> = ({ setActivePage }) => {
  ...
  const schoolImageUrl = '/images/gedungsatu.jpg';

  return (
    <div className="animate-fade-in">
      {/* Hero Banner */}
      <section className="relative h-[60vh] bg-cover bg-center" style={{ backgroundImage: "url('https://raw.githubusercontent.com/Firman7z/SMK-UMAR-FATAH/main/public/images/kisatu.jpg')" }}>
